          ...
          <View style={{marginBottom: 23}}>
              <PrivacySection
                  ...
                  items={[
                      ...
                      {icon: "comment-text-outline", label: "Limited Notification Info"},
              ...
              <PrivacySection
                  title={"Private Data"}
                  subtitle={style =>
                      <View style={{flexDirection: "row", marginLeft: style.marginLeft, marginRight: style.marginRight}}>
                          <Text style={{...style, marginLeft: 0, marginRight: 0}}>
                              On device; the Scorecard team&nbsp;</Text>
                          <Text style={{...style, color: "#525252", marginLeft: 0, marginRight: 0}}>
                              cannot</Text>
                          <Text style={{...style,  marginLeft: 0, marginRight: 0}}>
                              &nbsp;access</Text>
                      </View>
