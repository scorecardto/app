...
export default function ShareClubInstagram(props: {
    ...
    useEffect(() => {
        if (viewRef) {
            setTimeout(() => captureRef(viewRef, {
                format: "png",
                quality: 1,
                result: "base64",
            }).then(b64 => {
                shareToInsta(`data:image/png;base64,${b64}`).then(props.navigation.goBack);
            }), 800);
        }
    }, [viewRef]);
    ...
    return <View>
        ...
        <View collapsable={false} ref={viewRef}>
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        >
                            <ScorecardImage id={club.picture!} width={IMAGE_SIZE} height={IMAGE_SIZE} />
                        </View>
                    </View>
                    <View style={{
                        width: "100%",
                        ...
                        <View style={{
                            ...
                            <Text style={{
                                fontSize: 16,
                                fontWeight: "bold",
                            }}>{club.code.toUpperCase()}.MYLASA.CLUB</Text>
                        </View>
                    </View>
                </View>
            </View>
            ...
            <View style={{
                ...
                <Image source={require("../../../../assets/icon.svg")} style={{
                    height: 50,
                    aspectRatio: 1,
                }} />
                <Text style={{
